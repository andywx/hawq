...
PG_KEYWORD("convert", CONVERT, COL_NAME_KEYWORD)
...
PG_KEYWORD("filesystem", FILESYSTEM, UNRESERVED_KEYWORD)    /* GPDB */
...
PG_KEYWORD("kb", KB, UNRESERVED_KEYWORD)
...
PG_KEYWORD("pb", PB, UNRESERVED_KEYWORD)
...
PG_KEYWORD("search", SEARCH, UNRESERVED_KEYWORD)           /* Reserved in standard */
...
PG_KEYWORD("testmotion", TESTMOTION, UNRESERVED_KEYWORD)
